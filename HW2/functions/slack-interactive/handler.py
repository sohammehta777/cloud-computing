...
def handle(req):
    urlstring = unquote(req).decode('utf8').strip('payload=')
        ...
        "attachments": [
            {
                ...
                "author_name": "Soham Mehta",
                "author_link": "https://github.com/sohammehta777/cloud-computing.git",
                "author_icon": "https://avatars.githubusercontent.com/u/94602854",
                "title": "COEN 241",
